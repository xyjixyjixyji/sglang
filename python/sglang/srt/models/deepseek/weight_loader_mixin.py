...
class DeepSeekV2WeightLoaderMixin:
    ...
    def __init__(self, is_nextn_model: bool = False):
        ...
        '''
        self.is_nextn_model = is_nextn_model
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        weights = self._maybe_quant_weights_to_fp8_ue8m0(
            weights, NVFP4_CKPT_FP8_ATTN_QUANT_MODULES, self.is_nextn_model
        )
        ...
        self._post_load_weights(weight_names=weight_names)
        ...
        for layer_id in layer_ids:
            ...
            if hasattr(self_attn.kv_b_proj, "qweight"):
                ...
                if awq_dequantize_f is not None:
                    ...
                    raise ValueError("AWQ dequantization is only supported on CUDA, HIP/ROCm, and NPU")
            else:
    ...
    def _maybe_quant_weights_to_fp8_ue8m0(
        self, weights, attn_quant_modules
    ):
        ...
        if self.is_nextn_model and enable_nextn_moe_bf16_cast_to_fp8(self.quant_config):
